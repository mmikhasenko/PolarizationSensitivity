...
tbs = tbs_Ξc2pKπ
isobars = (Kst872_pc, Kst872_pv, Λ1520_pc, Λ1520_pv, Δ1232_pc, Δ1232_pv)



let pars = [1, 0, 1, 0, 1, 0]
...
writedlm(joinpath("data","sims","sample_Kstar=1,1_Lambda=1.1,3.9_Delta=2,2.txt"),
...
# reading
let
    M = readdlm(joinpath("data","sims","sample_Kstar=1,1_Lambda=1.1,3.9_Delta=2,2.txt"))
